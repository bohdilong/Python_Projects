...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\scpog\PycharmProjects\Django_Checkbook'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\scpog\PycharmProjects\Django_Checkbook\Scripts\deactivate.nu'
